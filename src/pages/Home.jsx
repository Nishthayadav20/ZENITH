...
export default function Home({ onPageChange }) {
  ...
  // Show first 6 products in the featured collection to fill the wide screen grid
  ...
  return (
    <div className="space-y-24 pb-12">
      ...
      {/* Featured Collection Grid (Full width edge-to-edge layout) */}
      <section className="w-full px-6 sm:px-12 lg:px-20 py-24 bg-transparent space-y-8">
